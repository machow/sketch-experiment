...
},{"./src/instructs.js":6,"./src/trial.js":7,"paper/dist/paper-full.js":3}],2:[function(require,module,exports){
/*!
...
},{"tether":5}],5:[function(require,module,exports){
/*! tether 1.1.0 */
...
},{"jquery":2,"tether-shepherd":4}],7:[function(require,module,exports){
// Doers ----------------------------------
...
var Lines = exports.Lines = function (paper) {
    return {
        ...
        numDrawn: 0,
        numStrokes: 0,
        drawLine: function drawLine(_ref) {
        ...
        addPoint: function addPoint(_ref2) {
            var x = _ref2.x;
            var y = _ref2.y;

            return this.crnt_path.add([x, y]);
        },
        newPath: function newPath(_ref3) {
            var x = _ref3.x;
            var y = _ref3.y;
...
var Actions = exports.Actions = function (log, doers) {
    ...
    return Object.assign.apply(Object, [obj].concat(_toConsumableArray(doers)));
};
